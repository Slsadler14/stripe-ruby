...
class Stripe::Account
  ...
  def self.capabilitys_url(id, nested_id=T.unsafe(nil)); end
  ...
  def self.create_person(id, params=T.unsafe(nil), opts=T.unsafe(nil)); end

  def self.delete_external_account(id, nested_id, params=T.unsafe(nil), opts=T.unsafe(nil)); end

  def self.delete_person(id, nested_id, params=T.unsafe(nil), opts=T.unsafe(nil)); end

  def self.external_accounts_url(id, nested_id=T.unsafe(nil)); end

  def self.list_capabilities(id, params=T.unsafe(nil), opts=T.unsafe(nil)); end

  def self.list_external_accounts(id, params=T.unsafe(nil), opts=T.unsafe(nil)); end

  def self.list_persons(id, params=T.unsafe(nil), opts=T.unsafe(nil)); end

  def self.login_links_url(id, nested_id=T.unsafe(nil)); end

  def self.persons_url(id, nested_id=T.unsafe(nil)); end

  def self.retrieve_capability(id, nested_id, opts=T.unsafe(nil)); end

  def self.retrieve_external_account(id, nested_id, opts=T.unsafe(nil)); end

  def self.retrieve_person(id, nested_id, opts=T.unsafe(nil)); end

  def self.update_capability(id, nested_id, params=T.unsafe(nil), opts=T.unsafe(nil)); end

  def self.update_external_account(id, nested_id, params=T.unsafe(nil), opts=T.unsafe(nil)); end

  def self.update_person(id, nested_id, params=T.unsafe(nil), opts=T.unsafe(nil)); end
end
...
class Stripe::Customer
  extend ::Stripe::APIOperations::Delete::ClassMethods
  extend ::Stripe::APIOperations::Save::ClassMethods
  def self.balance_transactions_url(id, nested_id=T.unsafe(nil)); end

  def self.cash_balance_transactions_url(id, nested_id=T.unsafe(nil)); end

  def self.create_balance_transaction(id, params=T.unsafe(nil), opts=T.unsafe(nil)); end

  def self.create_source(id, params=T.unsafe(nil), opts=T.unsafe(nil)); end

  def self.create_tax_id(id, params=T.unsafe(nil), opts=T.unsafe(nil)); end

  def self.delete_source(id, nested_id, params=T.unsafe(nil), opts=T.unsafe(nil)); end

  def self.delete_tax_id(id, nested_id, params=T.unsafe(nil), opts=T.unsafe(nil)); end

  def self.list_balance_transactions(id, params=T.unsafe(nil), opts=T.unsafe(nil)); end

  def self.list_cash_balance_transactions(id, params=T.unsafe(nil), opts=T.unsafe(nil)); end

  def self.list_sources(id, params=T.unsafe(nil), opts=T.unsafe(nil)); end

  def self.list_tax_ids(id, params=T.unsafe(nil), opts=T.unsafe(nil)); end

  def self.retrieve_balance_transaction(id, nested_id, opts=T.unsafe(nil)); end

  def self.retrieve_cash_balance_transaction(id, nested_id, opts=T.unsafe(nil)); end

  def self.retrieve_source(id, nested_id, opts=T.unsafe(nil)); end

  def self.retrieve_tax_id(id, nested_id, opts=T.unsafe(nil)); end

  def self.sources_url(id, nested_id=T.unsafe(nil)); end

  def self.tax_ids_url(id, nested_id=T.unsafe(nil)); end

  def self.update_balance_transaction(id, nested_id, params=T.unsafe(nil), opts=T.unsafe(nil)); end
...
class Stripe::Source
  extend ::Stripe::APIOperations::Save::ClassMethods
  def self.list_source_transactions(id, params=T.unsafe(nil), opts=T.unsafe(nil)); end

  def self.retrieve_source_transaction(id, nested_id, opts=T.unsafe(nil)); end

  def self.source_transactions_url(id, nested_id=T.unsafe(nil)); end
end
...
class Stripe::SubscriptionItem
  extend ::Stripe::APIOperations::Delete::ClassMethods
  extend ::Stripe::APIOperations::Save::ClassMethods
  def self.create_usage_record(id, params=T.unsafe(nil), opts=T.unsafe(nil)); end

  def self.list_usage_record_summaries(id, params=T.unsafe(nil), opts=T.unsafe(nil)); end

  def self.usage_record_summarys_url(id, nested_id=T.unsafe(nil)); end

  def self.usage_records_url(id, nested_id=T.unsafe(nil)); end
end
